    ...
    $( document ).ready(function() {
      ...
      $('#power-btn').on('click', function(){
          ...
          if (power >= fullpower && !disabled) {
              ...
              document.location.href=<?php echo e(BattleField::getHostJs()); ?>+'?do=iwin&p1=<?php echo e($battleField->getMyWarrior()->id); ?>&p2=<?php echo e($battleField->getOtherWarrior()->id); ?>';
          }
      });
      ...
      function powerdown() {
        ...
        if (power <=0  && !disabled) {
            ...
            document.location.href=<?php echo e(BattleField::getHostJs()); ?>+'?do=ilost&p1=<?php echo e($battleField->getMyWarrior()->id); ?>&p2=<?php echo e($battleField->getOtherWarrior()->id); ?>';
        }
